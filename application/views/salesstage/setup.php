...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">ILCS MANAGEMENT PORTAL - <?=$this->session->userdata('role');?></h1>
      <ol class="breadcrumb">
        <li class="active">Sales Stage Management -- Master Sales Stage</li>
    </ol>

     <!-- Start Page Header Right Div -->
    <div class="right">
      <div class="btn-group" role="group" aria-label="...">
        <a href="<?=_URL?>master_salesstage/salesstageList" class="btn btn-light">List Sales Stage</a>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <form action="<?php echo _URL;?>master_salesstage/doSetupSalesStage" method="post">
		
                <div class="form-group"><label>Sales Stage Name</label>
...
function addType(){
            var table=document.getElementById("salesstageTable");
            ...
            var t2=document.createElement("input");
                t2.id = "type"+index;
				t2.placeholder = "Sales Stage Name";
				t2.name = "type[]";
            ...
            var t4 = document.createElement("button");
				...
				t4.innerHTML  = "Add Sales Stage Component";
				t4.onclick = function(){
