  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <form action="<?php echo _URL;?>project/doAddProjectOpp" method="post">
            <table  class="table display">
				...
				<tr>
                        <td>
							Handover from Opportunity</td> <td> : </td> <td> 
															<select  class="selectpicker" name="opp_id" />
																<?php
																foreach($opportunities as $opportunity)
																{																
																?>
																	<option value="<?=$opportunity->ID?>" <?php if($opportunity->ID == $id_opp){?> selected <?php } ?>><?=$opportunity->NAME?></option>
																<?php
																}
																?>
															</select>
