    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <?php } ?>
                                ...
                                {
                                ?>
        <form action="<?php echo _URL;?>User/doEditUser/<?=$user->ID?>" method="post">
            <table id="example0" class="table display">
                <tr>
                        <td>Name</td> <td> : </td> <td> <input type="text" class="form-control" name="name" style="width:300px" value="<?=$user->NAME?>" /></td>
				</tr>
                                <?php
                                }
                                ?>
                        ...
                        <td>
							Posisi</td> <td> : </td> <td>
															<select  class="selectpicker" name="type" />
																...
																{
																?>
																	<option value="<?=$type->ID?>" <?php if($userInfo->TY_ID == $type->ID){ ?> selected <?php } ?>><?=$type->NAME?></option>
																<?php
																}
																?>
															</select>
				...
				<tr>
					<td colspan="4"><input type="submit" value="Edit User" class="btn btn-default"/></td>
				</tr>
