...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">ILCS MANAGEMENT PORTAL - <?=$this->session->userdata('role');?></h1>
      <ol class="breadcrumb">
        <li class="active">Specialization Management -- Master Specialization</li>
    </ol>

     <!-- Start Page Header Right Div -->
    <div class="right">
      <div class="btn-group" role="group" aria-label="...">
        <a href="<?=_URL?>Master_Specialization/specializationList" class="btn btn-light">List Specialization</a>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <form action="<?php echo _URL;?>Master_Specialization/doSetupSpecialization" method="post">
...
function addType(){
            var table=document.getElementById("specializationTable");
            ...
            var t2=document.createElement("input");
                t2.id = "type"+index;
				t2.placeholder = "Specialization Name";
				t2.name = "type[]";
            ...
            var t4 = document.createElement("button");
				...
				t4.innerHTML  = "Add Specialization Component";
				t4.onclick = function(){
